...
{ 
    ...
    { 
        ...
        return view('employees.show',compact('user', 'roles', 'roles_ids'));
    }
    ...
    { 
        ...
        return view('employees.edit',compact('user', 'roles', 'roles_ids'));
    }
    ...
    { 
        ...
        return view('employees.edit_password',compact('user'));
    }
